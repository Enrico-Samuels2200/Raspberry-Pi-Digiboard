...
// Setting up OpenWeatherMap API_KEY

const apiKey = `${process.env.API_KEY}`;

// Setting up express app and body-parser configurations
// Setting upjavascript template view engine
...
app.post('/', function(req, res) {
    ...
    let url = `http://pro.openweathermap.org/data/2.5/forecast/hourly?q=capetown&appid=`;
